...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerB: 'ᴏɴʟʏ ғᴏʀ ⁩ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩🥂',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 777888, "message": teks, "footerText": "*_© ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
               case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩⁩🙂"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩🙂"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩⁩🙂"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩⁩🙂"; break;
                case 4: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ😊"; break;
                case 5: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ😊"; break;
                case 6: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ\n- ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩⁩😊"; break;
            ...
            switch(jamss){
                ...
                case 4: jamss = "ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ🌚⁩"; break;
                case 5: jamss = "ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ🌚⁩"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/918590634460?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
༆ᴀᴅɪᴛʜʜᴀʀɪ / ᴀᴍᴇᴇɴ / ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩༄
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
sendButLocation(from, `${menu}`, "ꪶᴛᴏᴍ sᴇʀꫂ⁩⁩", {jpegThumbnail:gambar,name:""}, [{buttonId:`about`,buttonText:{displayText:'ᴀʙᴏᴜᴛ'},type:1},{buttonId:`donate`,buttonText:{displayText:'ᴅᴏɴᴀᴛᴇ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
case 'p':
...
const buttonMessage = {
    contentText: `${anu}`,
    footerText: '*_©ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩_*',
    buttons: buttons,
    headerType: 1
}
...
╰───────────────𒈒
 ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩💝
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 8888888, "message": `${yez}`, "footerText": "©ī.ᴀᴍ/ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩", "thumbnail": fs.readFileSync('./denz.jpg'), "surface": 'CATALOG'}}, {quoted: mek})
...
const btnbc = {
    ...
    footerText: '*_ʙʀᴏᴀᴅᴄᴀsᴛ ʙʏ ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩_*',
    buttons: buttonss,
    headerType: 1
}
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* : ꪶ͢ᴛᴏᴍ sᴇʀꫂ
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩
┃𒈒 *ᴄʀᴇᴀᴛᴏʀ* : @918590634460
┃𒈒 *sᴘᴇᴇᴅ* : 00065
┗━━𒆜
*ᴘʀɪᴠᴀᴛᴇ ʙᴏᴛ ᴀɴɴ ᴍᴡᴏɴᴇ*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ꪶ͢ᴛᴏᴍ sᴇʀꫂ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg')}}})
break
case 'donate':
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ᴇʀʀᴏʀ-ᴀʟᴇʀᴛ* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ꪶ͢ᴛᴏᴍ sᴇʀꫂ⁩",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./denz.jpg'),sourceUrl:"https://wa.me/918590634460?text=Hi Bro"}}})
	}
    }
    }
    }
